        ...
        <div class="mdl-layout__content">
            <div id="layout-padding" class="mdl-cell mdl-cell--8-col-desktop mdl-cell--2-offset-desktop mdl-cell--12-col-tablet mdl-cell--0-offset-tablet">
                ...
                <article id="mvv" class="mdl-cell mdl-cell--12-col mdl-grid">
                    <section class="fadeInUp delay-3-5s mdl-cell mdl-cell--4-col-desktop mdl-cell--12-col-tablet mdl-card mdl-shadow--4dp">
                        <hgroup class="mdl-card__title">
                ...
                <article id="carousel" class="fadeInUp delay-4s mdl-cell mdl-cell--12-col mdl-grid">
                    <section>
                        <figure>
                            <img class="mdl-shadow--4dp" src="./images/product_merco.png" alt="Merco Parts">
                            <img class="mdl-shadow--4dp" src="./images/product_notus.png" alt="Notus">
                            <img class="mdl-shadow--4dp" src="./images/product_yiming.png" alt="Yiming Parts">
                            <img class="mdl-shadow--4dp" src="./images/product_metan.png" alt="Metan">
                            <img class="mdl-shadow--4dp" src="./images/product_brunko.png" alt="Brunko">
                            <img class="mdl-shadow--4dp" src="./images/product_ndflex.png" alt="NDflex">
                        </figure>
                    </section>
                    <section>
                        <button id="previous-button" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">
                            <i class="fas fa-arrow-circle-left"></i>
                        </button>
                        <button id="next-button" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">
                ...
                <article class="mdl-grid mdl-cell mdl-cell--12-col">
                    <section class="fadeInUp delay-5s mdl-cell mdl-cell--6-col-desktop mdl-cell--12-col-tablet mdl-card mdl-shadow--4dp">
                    ...
                    <section class="fadeInUp delay-5-2s mdl-cell mdl-cell--6-col-desktop mdl-cell--12-col-tablet mdl-card mdl-shadow--4dp">
                        <figure class="mdl-card__media">
                    ...
                    <section class="fadeInUp delay-5-4s mdl-cell mdl-cell--6-col-desktop mdl-cell--12-col-tablet mdl-card mdl-shadow--4dp">
                        <figure class="mdl-card__media">
                    ...
                    <section class="fadeInUp delay-5-6s mdl-cell mdl-cell--6-col-desktop mdl-cell--3-offset-desktop mdl-cell--12-col-tablet mdl-card mdl-shadow--4dp">
                        <figure class="mdl-card__media">
                ...
                <article id="contact" class="fadeInUp delay-6s mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp">
                ...
                <article class="fadeInUp delay-7s mdl-cell mdl-cell--12-col mdl-card">
                    <figure>
